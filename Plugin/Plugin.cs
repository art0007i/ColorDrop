...
#nullable enable
    ...
    public override void Load()
    {
        ...
        Enabled = Config.Bind("General", "Enabled", true, "Whether the mod is enabled.");
    ...
    {
        private static readonly MethodInfo openColorPickerMethod =
            typeof(ColorMemberEditorBase).GetMethod("OpenColorPicker", AccessTools.allDeclared);

        private static bool Prefix(ColorMemberEditorBase __instance, UIBuilder ui, RelayRef<IField> ____target,
            Sync<string> ____path, FieldDrive<colorX> ____colorDrive, FieldDrive<colorX> ____colorDriveNoAlpha)
        {
